...
class DefectoController extends Controller
{
    ...
    public function show(int $id)
    {
        ...
        return view('backend.pages.rutinas.defecto.rutinas-def', compact('defecto', 'ejercicios', 'lunes', 'martes', 'miercoles', 'jueves', 'viernes', 'sabado', 'domingo'));
    }
