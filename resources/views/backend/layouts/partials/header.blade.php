    ...
    <div class="topbar d-flex align-items-center">
      <nav class="navbar navbar-expand gap-3">
                    ...
                    <div class="col">
                      <a href="javascript:;">
                        <div class="app-box text-center">
                          <div class="app-icon">
                            <img
                              src="{{asset('admin-assets/images/app/slack.png')}}"
                              width="30"
                              alt=""
                            />
                          </div>
                    ...
                    <div class="col">
                      <a href="javascript:;">
                        <div class="app-box text-center">
                          <div class="app-icon">
                            <img
                              src="{{asset('admin-assets/images/app/behance.png')}}"
                              width="30"
                              alt=""
                            />
                          </div>
                    ...
                    <div class="col">
                      <a href="javascript:;">
                        <div class="app-box text-center">
                          <div class="app-icon">
                            <img
                              src="{{asset('admin-assets/images/app/google-drive.png')}}"
                              width="30"
                              alt=""
                            />
                          </div>
                    ...
                    <div class="col">
                      <a href="javascript:;">
                        <div class="app-box text-center">
                          <div class="app-icon">
                            <img
                              src="{{asset('admin-assets/images/app/outlook.png')}}"
                              width="30"
                              alt=""
                            />
                          </div>
                    ...
                    <div class="col">
                      <a href="javascript:;">
                        <div class="app-box text-center">
                          <div class="app-icon">
                            <img
                              src="{{asset('admin-assets/images/app/github.png')}}"
                              width="30"
                              alt=""
                            />
                          </div>
                    ...
                    <div class="col">
                      <a href="javascript:;">
                        <div class="app-box text-center">
                          <div class="app-icon">
                            <img
                              src="{{asset('admin-assets/images/app/stack-overflow.png')}}"
                              width="30"
                              alt=""
                            />
                          </div>
                  ...
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex align-items-center">
                      <div class="user-online">
                        <img
                          src="{{asset('admin-assets/images/avatars/avatar-1.png')}}"
                          class="msg-avatar"
                          alt="user avatar"
                        />
                      </div>
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <div class="position-relative">
                        <div class="cart-product rounded-circle bg-light">
                          <img
                            src="{{asset('admin-assets/images/products/11.png')}}"
                            class=""
                            alt="product image"
                          />
                        </div>
        ...
        <div class="user-box dropdown px-3">
          ...
          >
            <img
              src="{{asset('admin-assets/images/avatars/avatar-2.png')}}"
              class="user-img"
              alt="user avatar"
            />
            <div class="user-info">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
              <a
                class="dropdown-item d-flex align-items-center"
                href="{{ route('admin.logout.submit') }}"
