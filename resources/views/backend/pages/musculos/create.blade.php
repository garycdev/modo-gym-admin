                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('admin.musculos.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <label for="mus_nombre" class="form-label required_value">Nombre </label>
                                ...
                                <div class="col-md-12">
                                    <label for="mus_descripcion" class="form-label">Descripcion</label>
                                    <textarea class="form-control" id="mus_descripcion" name="mus_descripcion" placeholder="Descripcion" rows="5"></textarea>
                                </div>
                                <br>
                                <div class="col-md-12">
