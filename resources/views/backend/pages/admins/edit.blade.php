...
@section('title')
Editar Usuario Admin - Admin Panel
@endsection
...
<div class="page-wrapper">
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.admins.index') }}"><i class="bx bx-user">Usuario Admin</i></a>
                        </li>
        ...
        <div class="col-xl-6 mx-auto">
            <div class="card">
                <div class="card-body ">
                    <h4 class="header-title">Editar Usuario Admin - {{ $admin->name }}</h4>
                    @include('backend.layouts.partials.messages')

                    <form action="{{ route('admin.admins.update', $admin->id) }}" class="row g-3" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="col-md-12">
