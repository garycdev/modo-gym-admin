    ...
    <div class="page-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-3 col-xl-2">
                                @if (Auth::guard('admin')->user()->can('galeria.create'))
                                    <a href="{{ route('admin.galerias.create') }}" class="btn btn-primary mb-3 mb-lg-0"><i class='bx bxs-plus-square'></i>Nuevo Galeria</a>
                                @endif
                            </div>
        ...
        <div class="row">
            ...
            @if (Auth::guard('admin')->user()->can('galeria.edit'))
                <div class="col-lg-3 col-xl-2">
                    <a href="ecommerce-add-new-products.html" class="btn bg-light-success mb-3 mb-lg-0"><i class='bx bxs-edit'></i>Editar Titulo</a>
                </div>
            @endif
        </div>
            ...
            @foreach ($galeria->imagenes as $imagen)
                <div class="col">
                    <div class="card">
                        ...
                        <a href="javascript:;" class="position-absolute top-0 m-1">
