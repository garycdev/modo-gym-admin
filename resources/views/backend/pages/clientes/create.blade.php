    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Create Cliente</div>
                <div class="ps-3">
                        ...
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" method="POST"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="lesiones" name="lesiones" placeholder="Lesiones." rows="3"></textarea>
                                    <div class="invalid-feedback">
                                        Please enter a valid address.
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="objetivo" name="objetivo" placeholder="Objetivo." rows="3"></textarea>
                                    <div class="invalid-feedback">
                                        Please enter a valid address.
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="deportes" name="deportes" placeholder="Deportes." rows="3"></textarea>
                                    <div class="invalid-feedback">
                                        Please enter a valid address.
                                    </div>
                                </div>
