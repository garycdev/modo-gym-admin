                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.roles.index') }}"><i
                                        class="bx bx-category">Roles</i></a>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-3" id="name" value="{{ $role->name }}"
